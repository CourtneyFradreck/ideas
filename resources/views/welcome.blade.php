                        ...
                        <div class="px-3 pt-4 pb-2">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="card-title mb-0"><a href="#"> Klins
                                            </a></h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="hstack gap-2 mb-3">
                            ...
                            <div class="overflow-hidden">
                                <a class="h6 mb-0" href="#!">Klins Brother</a>
                                <p class="mb-0 small text-truncate">@Klins</p>
                            </div>
                        ...
                        <div class="hstack gap-2 mb-3">
                            ...
                            <div class="overflow-hidden">
                                <a class="h6 mb-0" href="#!">Klins Brother</a>
                                <p class="mb-0 small text-truncate">@Sparo</p>
                            </div>
                            <a class="btn btn-primary-soft rounded-circle icon-md ms-auto" href="#"><i
                                    class="fa-solid fa-plus"> </i></a>
                        </div>
